...
app.post('/myaction', function(req, res) {
    ...
    //connection.connect();
    connection.query('INSERT INTO users SET ?', record, function(err,res){
          if(err) throw err;
...
app.post('/verifyuser', function(req,res){
    ...
    var selectString = 'SELECT COUNT(email) FROM users WHERE email="'+req.body.email+'" AND pass="'+req.body.pass+'" ';
